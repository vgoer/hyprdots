...
sed '1,/^### DATA ###$/d' $0 |
rofi -show -dmenu  -theme-str "${fnt_override}" -theme-str "${r_override}" -theme-str "${icon_override}" -config "${roconf}" | 
cut -d ' ' -f 1 | tr -d '\n' | wl-copy

exit
### DATA ###
😀 Grinning face, smile, joy
😃 Grinning face with big eyes, joy, funny
😄 Grinning face with smiling eyes, joy, laugh
😁 Beaming face with smiling eyes, happy, kawaii
😆 Grinning squinting face, joy, laugh
😅 Grinning face with sweat, relief, laugh
🤣 Rolling on the floor laughing, rofl
😂 Tears of joy, laugh, happy tears
🙂 Slightly smiling face, smile
🙃 Upside down face, silly
😉 Winking face, mischievous, smile
😊 Smiling face with eyes, happy, shy
😇 Smiling face with halo, angel, heaven
🥰 Smiling face with hearts, love, affection
😍 Heart eyes, love, crush
🤩 Star struck, smile, starry
😘 Blowing a kiss, affection, kiss
😗 Kissing face, love, kiss
☺️ Blushing face, happy
😚 Kissing face with closed eyes, love, kiss
😙 Kissing face with smiling eyes, affection, kiss
😋 Savoring food, yummy, delicious
😛 Tongue out, playful, mischievous
😜 Winking with tongue, playful, mischievous
🤪 Zany face, goofy, crazy
😝 Squinting with tongue, playful, mischievous
